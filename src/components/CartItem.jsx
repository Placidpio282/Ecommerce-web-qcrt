...
import { removeFromCart, updateQuanlity } from '../store/cartSlice';
...
const handleQtyChange = (newQty) =>{
    if (newQty <= 0){
        ...
        dispatch(updateQuanlity({ id: item.id, quantity: newQty}))
    }
}
    ...
    return (
        <div className='flex items-center space-x-4 bg-gray-50 rounded-xl'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <button className='p-1 text-red-500 rounded-full hover:bg-red-50
