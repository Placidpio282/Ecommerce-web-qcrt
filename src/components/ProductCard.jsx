...
function ProductCard({ product }) {
  ...
  return (
    <div className='group bg-white rounded-2xl shadow:md hover:shadow-2xl
    transition-all duration-300 overflow-hidden border border-gray-100'>
      ...
      <div className='p-6'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <button className='group/btn bg-green-400 text-gray-900 px-4 py-2 
             rounded-lg hover:shadow-lg transform hover:scale-105 transition-all
             duration-200 flex items-center space-x-2 cursor-pointer' onClick={handleAddToCart}>
